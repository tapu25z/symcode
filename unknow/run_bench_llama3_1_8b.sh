...
# Benchmark 50 samples MATH-500: meta-llama/Llama-3.1-8B-Instruct (4-bit NF4)
# Model: meta-llama/Llama-3.1-8B-Instruct
# ==============================================================================
# Usage:
#   chmod +x unknow/run_bench_llama3_1_8b.sh
#   ./unknow/run_bench_llama3_1_8b.sh                 # Chay mac dinh
#   ./unknow/run_bench_llama3_1_8b.sh <HF_TOKEN>      # Truyen truc tiep HF_TOKEN
# ==============================================================================
...
LOG_FILE="logs/run_bench_llama3_1_8b_$(date '+%Y%m%d_%H%M%S').log"

echo "======================================================================"
echo "🎯 Bat dau chay Benchmark: Benchmark 50 samples MATH-500: meta-llama/Llama-3.1-8B-Instruct (4-bit NF4)"
echo "   - Model        : meta-llama/Llama-3.1-8B-Instruct"
...
python3 kaggle/run_benchmark.py \
    --dataset math500 --dataset-path "kaggle/data/math500/test_50_stratified.jsonl" --num-samples 50 --run-order by-problem \
...
echo "======================================================================"
echo "🎉 Hoan tat Benchmark cho meta-llama/Llama-3.1-8B-Instruct!"
