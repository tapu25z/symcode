...
# Full MATH-500: meta-llama/Llama-3.2-3B-Instruct (4-bit NF4)
# Model: meta-llama/Llama-3.2-3B-Instruct
# ==============================================================================
# Usage:
#   chmod +x unknow/run_full_llama3_2_3b.sh
#   ./unknow/run_full_llama3_2_3b.sh                 # Chay mac dinh
#   ./unknow/run_full_llama3_2_3b.sh <HF_TOKEN>      # Truyen truc tiep HF_TOKEN
# ==============================================================================
...
OUTPUT_RESULT="results/results_full_math500_llama3_2_3b.json"
LOG_FILE="logs/run_full_llama3_2_3b_$(date '+%Y%m%d_%H%M%S').log"

echo "======================================================================"
echo "🎯 Bat dau chay Benchmark: Full MATH-500: meta-llama/Llama-3.2-3B-Instruct (4-bit NF4)"
echo "   - Model        : meta-llama/Llama-3.2-3B-Instruct"
...
echo "======================================================================"
echo "🎉 Hoan tat Benchmark cho meta-llama/Llama-3.2-3B-Instruct!"
