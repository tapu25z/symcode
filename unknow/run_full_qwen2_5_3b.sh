...
# Full MATH-500: Qwen/Qwen2.5-3B-Instruct (4-bit NF4)
# Model: Qwen/Qwen2.5-3B-Instruct
# ==============================================================================
# Usage:
#   chmod +x unknow/run_full_qwen2_5_3b.sh
#   ./unknow/run_full_qwen2_5_3b.sh                 # Chay mac dinh
#   ./unknow/run_full_qwen2_5_3b.sh <HF_TOKEN>      # Truyen truc tiep HF_TOKEN
# ==============================================================================
...
OUTPUT_RESULT="results/results_full_math500_qwen2_5_3b.json"
LOG_FILE="logs/run_full_qwen2_5_3b_$(date '+%Y%m%d_%H%M%S').log"

echo "======================================================================"
echo "🎯 Bat dau chay Benchmark: Full MATH-500: Qwen/Qwen2.5-3B-Instruct (4-bit NF4)"
echo "   - Model        : Qwen/Qwen2.5-3B-Instruct"
...
echo "======================================================================"
echo "🎉 Hoan tat Benchmark cho Qwen/Qwen2.5-3B-Instruct!"
