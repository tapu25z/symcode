...
# Full MATH-500: meta-llama/Llama-3.1-8B-Instruct (4-bit NF4)
# Model: meta-llama/Llama-3.1-8B-Instruct
# ==============================================================================
# Usage:
#   chmod +x unknow/run_full_llama3_1_8b.sh
#   ./unknow/run_full_llama3_1_8b.sh                 # Chay mac dinh
#   ./unknow/run_full_llama3_1_8b.sh <HF_TOKEN>      # Truyen truc tiep HF_TOKEN
# ==============================================================================
...
OUTPUT_RESULT="results/results_full_math500_llama3_1_8b.json"
LOG_FILE="logs/run_full_llama3_1_8b_$(date '+%Y%m%d_%H%M%S').log"

echo "======================================================================"
echo "🎯 Bat dau chay Benchmark: Full MATH-500: meta-llama/Llama-3.1-8B-Instruct (4-bit NF4)"
echo "   - Model        : meta-llama/Llama-3.1-8B-Instruct"
