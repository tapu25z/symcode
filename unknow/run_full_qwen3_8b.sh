...
# Full MATH-500: Qwen/Qwen3-8B (4-bit NF4)
# Model: Qwen/Qwen3-8B
# ==============================================================================
# Usage:
#   chmod +x unknow/run_full_qwen3_8b.sh
#   ./unknow/run_full_qwen3_8b.sh                 # Chay mac dinh
#   ./unknow/run_full_qwen3_8b.sh <HF_TOKEN>      # Truyen truc tiep HF_TOKEN
# ==============================================================================
...
OUTPUT_RESULT="results/results_full_math500_qwen3_8b.json"
LOG_FILE="logs/run_full_qwen3_8b_$(date '+%Y%m%d_%H%M%S').log"

echo "======================================================================"
echo "🎯 Bat dau chay Benchmark: Full MATH-500: Qwen/Qwen3-8B (4-bit NF4)"
echo "   - Model        : Qwen/Qwen3-8B"
...
echo "======================================================================"
echo "🎉 Hoan tat Benchmark cho Qwen/Qwen3-8B!"
