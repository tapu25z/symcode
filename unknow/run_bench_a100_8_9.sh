...
# Benchmark 50 samples MATH-500: Qwen/Qwen3-4B (4-bit NF4)
# Model: Qwen/Qwen3-4B
# ==============================================================================
# Usage:
#   chmod +x unknow/run_bench_a100_8_9.sh
#   ./unknow/run_bench_a100_8_9.sh                 # Chay mac dinh
#   ./unknow/run_bench_a100_8_9.sh <HF_TOKEN>      # Truyen truc tiep HF_TOKEN
# ==============================================================================
...
OUTPUT_RESULT="results/results_a100_8_9_math500_50samples_qwen3_4b.json"
LOG_FILE="logs/run_bench_a100_8_9_$(date '+%Y%m%d_%H%M%S').log"

echo "======================================================================"
echo "🎯 Bat dau chay Benchmark: Benchmark 50 samples MATH-500: Qwen/Qwen3-4B (4-bit NF4)"
echo "   - Model        : Qwen/Qwen3-4B"
...
python3 kaggle/run_benchmark.py \
    --dataset math500 --dataset-path "kaggle/data/math500/test_50_stratified.jsonl" --num-samples 50 --disable-thinking --run-order by-problem \
...
echo "======================================================================"
echo "🎉 Hoan tat Benchmark cho Qwen/Qwen3-4B!"
