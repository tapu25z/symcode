...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--extractor-tokens", type=int, default=1000)
    parser.add_argument("--codegen-tokens", type=int, default=1400)
    parser.add_argument("--code-repair-tokens", type=int, default=1200)
