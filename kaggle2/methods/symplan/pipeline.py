...
class SymPlannerIRPipeline:
    def __init__(self, llm_call: Callable[[list[dict[str, str]]], str], execute_code: Callable[[str], Mapping[str, Any]], max_repairs: int = 2, max_ir_repairs: int = 1, ablation: str | AblationConfig | None = None):
